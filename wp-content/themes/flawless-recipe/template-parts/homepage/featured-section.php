...
$featured_recipe_category = $flawless_recipe_options['featured_recipe_category'];
?>

<?php
if ($featured_recipe_category && 'none' != $featured_recipe_category) {
    $args = [
        'post_type' => 'post',
        'posts_per_page' => 4,
        'post_status' => 'publish',
        ...
        'tax_query' => [
            ...
            [
                'taxonomy' => 'category',
                'field' => 'slug',
                'terms' => [$featured_recipe_category],
            ],
        ],
    ];
} else {
